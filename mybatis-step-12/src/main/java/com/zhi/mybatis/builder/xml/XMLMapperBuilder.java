...
import com.zhi.mybatis.builder.ResultMapResolver;
import com.zhi.mybatis.io.Resources;
import com.zhi.mybatis.mapping.ResultFlag;
...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    private ResultMap resultMapElement(Element resultMapNode, List<ResultMapping> additionalResultMappings) throws Exception {
        ...
        for (Element resultChild : resultChildren) {
            ...
            // 构建 ResultMapping
            resultMappings.add(buildResultMappingFromContent(resultChild, typeClass, flags));
        }
    ...
    private ResultMapping buildResultMappingFromContent(Element context, Class<?> resultType, List<ResultFlag> flags) {
