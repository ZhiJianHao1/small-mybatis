...
import com.zhi.mybatis.reflection.invoker.GetFieldInvoker;
import com.zhi.mybatis.reflection.invoker.Invoker;
import com.zhi.mybatis.reflection.invoker.MethodInvoker;
import com.zhi.mybatis.reflection.invoker.SetFieldInvoker;
import com.zhi.mybatis.reflection.property.PropertyNamer;
...
public class Reflector {
    ...
    private final Logger logger = LoggerFactory.getLogger(Reflector.class);
            ...
            if (!currentMethod.isBridge()) {
                ...
                if (canAccessPrivateMethods()) {
                    try {
                        ...
                        // Ignored. This is a only a final precaution, noting we can do.
                    }
                }
    ...
    public static Reflector forClass(Class<?> clazz) {
        if (classCacheEnabled) {
            // synchronized (clazz) remove see issue
            // 对于每个类来说，我们假设他是不会变的，这样可以考虑将这个类信息(构造函数， getter， setter， 字段) 加入缓存，以提高速度
