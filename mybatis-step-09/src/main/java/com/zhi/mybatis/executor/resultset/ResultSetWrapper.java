 ...
 * 结果集包装器
 * @author zhijianhao
 * @created by zhijianhao on 2023/5/3-16:26
 */
public class ResultSetWrapper {
    ...
    private void loadMappedAndUnmappedColumnNames(ResultMap resultMap, String columnPrefix) throws SQLException {
        ...
        final String upperColumnNames = columnPrefix == null ? null : columnPrefix.toUpperCase(Locale.ENGLISH);
        final Set<String> mappedColumns = prependPrefixes(resultMap.getMappedColumns(), upperColumnNames);
        for (String columnName : columnNames) {
            final String upperColumnName = columnName.toUpperCase(Locale.ENGLISH);
            if (mappedColumns.contains(upperColumnName)) {
                mappedColumns.add(upperColumnName);
            } else {
    ...
    public List<String> getUnmappedColumnNames(ResultMap resultMap, String columnPrefix) throws SQLException {
        List<String> unMappedColumnNames = mappedColumnNamesMap.get(getMapKey(resultMap, columnPrefix));
